...
class Options_Framework_Admin {
	...
	static function menu_settings() {
            ...
            'page_title' => __( '网站功能设置', 'theme-textdomain' ),
			'menu_title' => __( '网站功能设置', 'theme-textdomain' ),
	...
	/*function enqueue_admin_styles_post()
	{
	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
		    <div id="optionsframework" class="postbox">
				...
				<div id="optionsframework-submit">
					...
					<!-- <input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( '重置所有设置', 'theme-textdomain' ); ?>" onclick="return confirm( '<?php print esc_js( __( '确定重置全部设置？', 'theme-textdomain' ) ); ?>' );" /> -->
					<div class="clear"></div>
				</div>
				</form>
			</div>
