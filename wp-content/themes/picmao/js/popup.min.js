jQuery(function(t) {
    ...
    customModalTemplate = {
        ...
        PayMethod: function(t) {
            return '\n     <div class="pay-button-box"> <div class="pay-item" data-id="1"><i class="alipay"></i><span>支付宝</span></div> <!--<div class="pay-item" data-id="2" style="border-bottom:0;"><i class="weixinpay"></i><span>微信支付</span></div>--> </div> \n '
        },
        Download: function(t) {
